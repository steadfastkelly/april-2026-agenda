...
export interface ScheduleEvent {
  id: string;
  day: number; // 0=Monday, 1=Tuesday, 2=Wednesday, 3=Thursday
...
// ── Event Data ─────────────────────────────────────────────────────
// `color` is intentionally absent — it is derived from `category` at render time.
export const events: ScheduleEvent[] = [
  ...
  },
  {
    ...
    category: "MEETING",
    badge: "AM",
    title: "Team Sync: Handling UI Event + Delegation",
    titleDark: "Team Sync:",
